...
xmax = 3
ytop = 1.2
xticks = np.array([-3.0,-2,-1,0,1,2,3])
...
ax.set_xticklabels(xticks,fontsize=size-2)
ax.set_yticks(yticks)
ax.set_yticklabels(yticks,fontsize=size-2)

ax.set_ylabel('Intensity', fontsize=size)
ax.set_xlabel('Position (nm)', fontsize=size)

ax.text(-4.1, 1.09, '(d)',fontsize=size)
...
plt.savefig("Figure_6d.png", dpi=1000)
