...
fig.tight_layout(rect=[0.07,0.08,0.91,1])
...
ax1.text(-280,1.1-0.02, '(a)',fontsize= size)
...
ax1.text(-20, 0.05, 'Phase', fontsize = size)
ax2.text(-40, 0.6, 'Amplitude', color='r', fontsize = size)
...
plt.savefig("Figure_6a.png", dpi=1000)
