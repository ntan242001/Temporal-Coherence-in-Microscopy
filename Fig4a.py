...
for i in range(2):
    ...
    ax[i].axvline(x=q_apNAC_G/1e9, color='b', linestyle='-.', linewidth=2)
    ax[i].axvline(x=q_apNAC_FE/1e9, color='r', linestyle=':', linewidth=2)
...
x0=0.022
ax1.text(-.123, 1.1, '(a)',fontsize=size)
ax1.text(x0, 0.4, 'NAC',fontsize=size)
...
plt.savefig("Figure_4a.png", dpi=1000)
